              ...
              <div className="replyToTooltip">
                <span className="popover-container">
                  ...
                  <div className="popoverText">
                    Selecting this will automatically fill your reply address
                    when try to reply to notification email. You can also use
                    Email elements in the form for dynamic Reply to
                  </div>
                </span>
              </div>
              <select
